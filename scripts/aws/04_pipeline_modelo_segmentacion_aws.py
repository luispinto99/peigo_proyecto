...
BUCKET = "peigo"
PROCESSED_DIR = f"s3://{BUCKET}/data/trusted"
FOR_MODELLING_DIR = f"s3://{BUCKET}/data/for_modelling"
clientes = pd.read_parquet(f"{PROCESSED_DIR}/clientes/clientes.parquet")
tarjetas = pd.read_parquet(f"{PROCESSED_DIR}/tarjetas/tarjetas.parquet")
transacciones = pd.read_parquet(f"{PROCESSED_DIR}/transacciones/transacciones.parquet")
marketing = pd.read_parquet(f"{PROCESSED_DIR}/interacciones_marketing/interacciones_marketing.parquet")
...
destino = f"{FOR_MODELLING_DIR}/base_segmentacion/base_segmentacion.parquet"
